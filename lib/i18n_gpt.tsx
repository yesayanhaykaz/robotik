...
const translations = {
  en: {
    ...
    home: {
      ...
      heroTitle2: 'into',
      heroTitle3: 'real circuits.',
      heroSubtitle: 'Online electronics and robotics lessons for kids ages 7–15. Learn Arduino, circuits, sensors, and coding through short videos, real projects, and hands-on STEM building.',
      heroStartLearning: 'Start Learning',
      heroSeeLessons: 'See Lessons',
      statConcepts: 'Core Concepts',
      statLessons: 'Project Lessons',
      statAges: 'Target Ages',
      statFree: 'Free',
      statFreeLabel: 'To Start Learning',
      methodLabel: 'The Method',
      methodTitle: 'Three simple steps to thinking like an engineer',
      methodSubtitle: 'Every lesson follows the same rhythm, so children build confidence fast: understand the idea, build the circuit, and see the result with their own eyes.',
      step1Title: 'Watch',
      step1Desc: 'Short, focused videos from 1 to 5 minutes. One concept, one analogy, one clear takeaway. No fluff, no confusion.',
      step2Title: 'Build',
      step2Desc: 'Follow along with the starter kit using real Arduino parts, real wires, real components, and real beginner code. This is hands-on electronics for kids.',
      step3Title: 'Understand',
      step3Desc: 'When the LED blinks, the button works, or the motor spins, the lesson becomes real. That moment builds confidence and long-term understanding.',
      conceptsLabel: 'Knowledge Base',
      conceptsTitle: 'Everything starts with understanding',
      conceptsSubtitle: 'Before a child builds a robot or writes Arduino code, they need to understand electricity, voltage, current, resistance, signals, and components. Each concept is explained simply in a short video.',
      viewAll10: 'View All 22',
      watchConcept: 'Watch concept →',
      lessonsLabel: 'Project Lessons',
      lessonsTitle: 'Build something real — today',
      lessonsSubtitle: 'Every lesson ends with a real working result. Not just theory. Not just a simulator. A real circuit built by your child with their own hands.',
      viewAllLessons: 'View All Lessons',
      watchLesson: 'Watch lesson →',
      whatYouNeed: 'What you need',
      comingSoonLabel: 'Coming Soon',
      comingSoonTitle: 'Lessons 03–10 are in development',
      comingSoonDesc: 'Buzzer alarm, sensors, traffic light, temperature monitor, servo motor, mini robot, and more beginner Arduino projects for kids.',
      getNotified: 'Get notified →',
      kitLabel: 'Starter Kit',
      kitTitle: 'Everything needed to start building today',
      kitDesc1: 'The Robotik kit is built around the lessons. Every part used in the videos is included in the box, so parents do not need to guess what to buy.',
      kitDesc2: 'One kit covers the beginner path. When your child is ready for more, advanced kits add motors, displays, sensors, and wireless modules for bigger robotics projects.',
      orderKit: 'Order Starter Kit →',
      kitShips: 'Ships within Armenia · Designed for ages 8+',
      missionLabel: 'Why Robotik',
      missionQuote: "\"We don't teach children to only use technology. We teach them to understand it and create it.\"",
      missionQuote1: "We don't teach children to use technology.",
      missionQuote2: 'We teach them to',
      missionQuote3: 'create',
      missionQuote4: 'it.',
      missionDesc: 'Kids spend hours using apps, games, and videos, but very few understand how technology actually works. Robotik changes that. A child who can wire an LED, read a simple circuit, and upload code to Arduino starts seeing technology as something they can control, build, and improve.',
      point1Title: 'Engineering mindset, not just coding',
      point1Desc: 'We teach systems thinking: inputs, outputs, logic, components, cause and effect, and how real devices work together.',
      point2Title: 'Confidence through real results',
      point2Desc: 'Every lesson ends with something visible and working. The LED blinks. The button responds. The child sees, “I built this.”',
      point3Title: 'Built for the future',
      point3Desc: 'As AI changes the world, children who understand systems, electronics, robotics, and technology will have a real advantage.',
      parentsLabel: 'For Parents',
      parentsTitle: "What you're really investing in",
      parentsSubtitle: 'More than “Arduino lessons.” This is practical STEM education with real outcomes.',
      parent1Title: 'Useful screen time',
      parent1Desc: 'Instead of passive scrolling, your child uses screen time to learn, build, test, and understand real technology.',
      parent2Title: 'Future-ready skills',
      parent2Desc: 'Robotics, electronics, coding, logic, and engineering thinking are among the most valuable skills a child can develop today.',
      parent3Title: 'Practical creativity',
      parent3Desc: 'Your child does not just watch. They build, experiment, make mistakes, fix them, and discover how ideas become working systems.',
      parent4Title: 'Confidence with technology',
      parent4Desc: 'A child who builds circuits and understands how devices work becomes far less intimidated by any future technology.',
      parent5Title: 'Not gaming — making',
      parent5Desc: 'Games consume attention. Building creates ability. Robotik keeps the excitement while turning it into something useful.',
      parent6Title: 'Real STEM education',
      parent6Desc: 'Not worksheets and memorization. Real project-based learning that children remember, talk about, and proudly show to others.',
      ctaTitle: 'Ready to start building?',
      ctaSubtitle: 'Start with free electronics lessons today. Add the Robotik Starter Kit when you are ready for hands-on Arduino building.',
    ...
    conceptsPage: {
      ...
      title1: '22 Core',
      title2: 'Concepts',
      subtitle: 'Before building real projects, kids need to understand the building blocks of electronics. Each concept is explained in a short 1–2 minute video using simple language and real-life analogies.',
      concept: 'Concept',
    ...
    conceptDetail: {
      ...
      readyToBuildDesc: 'Take this idea from theory to practice with a hands-on project lesson.',
    ...
    lessonsPage: {
      ...
      title2: 'real',
      title3: 'today',
      subtitle: 'Each lesson ends with a working result. Not just a diagram. Not just a simulation. A real beginner electronics project built with real Arduino components.',
      whatYouNeed: 'What you need',
      ...
      comingSoonLabel: 'Coming Soon',
      comingSoonTitle: 'Lessons 03–10 are in development',
      comingSoonDesc: 'Buzzer alarm, sensors, traffic light, temperature monitor, servo motor, mini robot, and more hands-on STEM lessons are on the way.',
    ...
    lessonDetail: {
      ...
      dontHavePartsDesc: 'The Robotik Starter Kit includes everything needed for this lesson and the full beginner path.',
      orderKit: 'Order Starter Kit →',
      conceptsUsed: 'Concepts Used',
      tryCircuit: 'Try the Circuit',
      tryCircuitDesc: 'Interact with the circuit right here. Click, test, observe, and start understanding how electronics behaves.',
    ...
    footer: {
      ...
      tagline: 'Teaching kids to understand, build, and create — not just consume technology.',
    },
    kitPage: {
      back: '← Back to Home',
      label: 'Starter Kit',
      title1: 'Choose Your',
      title2: 'Kit',
      subtitle: 'Everything needed to follow our lessons with confidence. Each kit is designed around real beginner electronics and Arduino projects, with the exact components children need to succeed.',
      whatsIncluded: "What's Included",
      perfectFor: 'Perfect for',
      orderNow: 'Order Now →',
      comingSoon: 'Coming Soon',
      questionsTitle: 'Have questions about the kits?',
      questionsDesc: 'Write to us and we will help you choose the best kit for your child’s age, level, and learning goals.',
      contactUs: 'Contact Us →',
      shipsNote: 'All kits ship within Armenia. International shipping is planned for a future release.',
      kit1Name: 'Blink Starter Kit',
      kit1Desc: 'The perfect first step into electronics for kids. Build a real LED circuit, upload code, and complete Lesson 01 with confidence.',
      kit1For: 'Lesson 01 — First Blink',
      kit1Price: '12,000 AMD',
      kit2Name: 'Button Control Kit',
      kit2Desc: 'Add interactivity with a pushbutton and learn how Arduino reacts to input. Covers Lessons 01–02 and introduces true cause-and-effect building.',
      kit2For: 'Lessons 01–02',
      kit2Price: '18,000 AMD',
      kit3Name: 'Full Beginner Kit',
      kit3Desc: 'The complete beginner package for children who want the full hands-on experience. Covers early lessons with LEDs, buttons, buzzers, sensors, and more.',
      kit3For: 'All Beginner Lessons (01–05)',
      kit3Price: '35,000 AMD',
      kit3Badge: 'Best Value',
      kit4Name: 'Advanced Explorer Kit',
      kit4Desc: 'For kids ready to move beyond basics. Includes advanced components like servo motors, LCD display, IR remote, and wireless modules for bigger robotics builds.',
...
signal: {
  ...
  analogy: 'Like a message being sent — the shape of the signal is the meaning.',
      ...
      electricity: {
        ...
        description: 'Electricity is the movement of electrons through a material, and it is what makes lights, robots, sensors, and circuits work.',
        analogy: 'Like lots of tiny runners moving through one hallway — when they move together, the whole system comes alive.',
      },
      voltage: {
        title: 'What is Voltage?',
        description: 'Voltage is the push behind electricity. It is the electrical pressure that moves electrons through a circuit.',
        analogy: 'Like water pressure in a pipe — higher pressure means a stronger push.',
      },
      current: {
        title: 'What is Current?',
        description: 'Current tells you how much electricity is actually flowing through a wire or component at a given time.',
        analogy: 'Like how many kids are running through the hallway at the same time.',
      },
      resistance: {
        title: 'What is Resistance?',
        description: 'Resistance is what slows electric flow and keeps current under control inside a circuit.',
        analogy: 'Like a narrow section of hallway that makes everyone slow down.',
      },
      resistor: {
        title: 'What is a Resistor?',
        description: 'A resistor is a component that adds a controlled amount of resistance to protect parts like LEDs from too much current.',
        analogy: 'Like a speed bump that stops electricity from rushing too fast.',
      },
      diode: {
      ...
      microcontroller: {
        ...
        description: 'A microcontroller is a tiny computer that reads inputs, makes decisions in code, and controls outputs like LEDs, sensors, and motors.',
        analogy: 'Like a tiny brain that can sense the world and control things in it.',
      },
    },
    ...
    lessons: {
      blink: {
        ...
        description: 'Start from zero and build your first working Arduino circuit. Learn the breadboard, connect an LED safely, write simple code, and watch your first electronics project blink to life.',
        steps: [
      ...
      button: {
        ...
        badge: 'Beginner',
        description: 'Add your first real input to the circuit. Learn how a pushbutton talks to Arduino, how code reacts to that signal, and how a simple if/else turns a passive circuit into an interactive project.',
        steps: [
...
hy: {
  ...
  home: {
    heroBadge: 'Մանկական ռոբոտաշինություն և էլեկտրոնիկա',

    heroTitle1: 'Հետաքրքրությունը',
    heroTitle2: 'վերածիր',
    heroTitle3: 'իրական սխեմաների։',

    heroSubtitle:
      'Առցանց Arduino-ի, էլեկտրոնիկայի և ռոբոտաշինության դասեր 7–15 տարեկան երեխաների համար Հայաստանում։ Դիտիր, կառուցիր իրական նախագծեր և զարգացրու ինժեներական մտածողություն։',

    heroStartLearning: 'Սկսել սովորել',
    heroSeeLessons: 'Տեսնել դասերը',

    statConcepts: 'Հիմնական հասկացություններ',
    statLessons: 'Նախագծային դասեր',
    statAges: 'Տարիքային խումբ',
    statFree: 'Անվճար',
    statFreeLabel: 'Սկսելու համար',

    methodLabel: 'Մեթոդ',
    methodTitle: 'Երեք քայլ՝ ինժեների պես մտածելու համար',
    methodSubtitle:
      'Յուրաքանչյուր դաս կառուցված է պարզ մեթոդով՝ հասկանալ, կառուցել և տեսնել արդյունքը սեփական աչքերով։',

    step1Title: 'Դիտիր',
    step1Desc:
      'Կարճ և հստակ տեսանյութեր՝ 1-ից 5 րոպե։ Մեկ գաղափար, մեկ պարզ բացատրություն։',

    step2Title: 'Կառուցիր',
    step2Desc:
      'Աշխատիր իրական Arduino բաղադրիչներով՝ լարեր, breadboard, LED, սենսորներ։ Սա իրական փորձ է, ոչ թե տեսություն։',

    step3Title: 'Հասկացիր',
    step3Desc:
      'Երբ LED-ը թարթում է կամ կոճակը աշխատում է, երեխան հասկանում է՝ ինչ է տեղի ունենում։ Այդ պահը ձևավորում է վստահություն։',

    conceptsLabel: 'Գիտելիքների բազա',
    conceptsTitle: 'Ամեն ինչ սկսվում է հասկանալուց',
    conceptsSubtitle:
      'Մինչ կառուցելը, երեխան պետք է հասկանա՝ ինչ է էլեկտրականությունը, լարումը, հոսանքը և ինչպես են աշխատում բաղադրիչները։',
    ...
    lessonsTitle: 'Կառուցիր մի իրական բան՝ այսօր',
    lessonsSubtitle:
      'Յուրաքանչյուր դաս ավարտվում է աշխատող արդյունքով՝ իրական սխեմա, ոչ թե սիմուլյացիա։',

    viewAllLessons: 'Տեսնել դասերը',
    watchLesson: 'Դիտել →',

    whatYouNeed: 'Ինչ է պետք',

    comingSoonLabel: 'Շուտով',
    comingSoonTitle: 'Դասեր 03–10 մշակման փուլում են',
    comingSoonDesc:
      'Սենսորներ, լուսացույց, ջերմաչափ, սերվո շարժիչ, մինի ռոբոտ և այլ նախագծեր։',

    getNotified: 'Ստանալ ծանուցում →',

    kitLabel: 'Սկսնակ հավաքածու',
    kitTitle: 'Ամեն ինչ՝ սկսելու համար',
    kitDesc1:
      'Բոլոր բաղադրիչները, որոնք տեսնում եք դասերում, արդեն ներառված են հավաքածուում։',
    kitDesc2:
      'Հարմար սկսնակների համար և ամբողջությամբ համընկնում է դասերի հետ։',

    orderKit: 'Պատվիրել →',
    kitShips: 'Առաքում ամբողջ Հայաստանում · 8+',

    missionLabel: 'Ինչու Robotik',

    missionQuote:
      '«Մենք երեխաներին չենք սովորեցնում միայն օգտագործել տեխնոլոգիան։ Մենք նրանց սովորեցնում ենք ստեղծել այն։»',

    missionDesc:
      'Այսօր երեխաները ժամեր են անցկացնում խաղեր օգտագործելով, բայց չեն հասկանում՝ ինչպես է դա աշխատում։ Robotik-ը տալիս է իրական գիտելիք՝ կառուցելով։',

    point1Title: 'Ինժեներական մտածողություն',
    point1Desc: 'Մուտք, ելք, տրամաբանություն և իրական համակարգերի հասկացում։',

    point2Title: 'Իրական արդյունք',
    point2Desc: 'Յուրաքանչյուր դաս ավարտվում է աշխատող արդյունքով։',

    point3Title: 'Ապագայի հմտություններ',
    point3Desc: 'Ռոբոտաշինություն, STEM և տեխնոլոգիական մտածողություն։',

    parentsLabel: 'Ծնողների համար',
    parentsTitle: 'Ինչ եք դուք իրականում ստանում',
    parentsSubtitle: 'Սա պարզապես դաս չէ։ Սա ներդրում է երեխայի ապագայի մեջ։',

    parent1Title: 'Օգտակար էկրանային ժամանակ',
    parent1Desc: 'Երեխան ստեղծում է, ոչ թե պարզապես դիտում։',

    parent2Title: 'Ապագայի հմտություններ',
    parent2Desc: 'STEM, ռոբոտաշինություն և ծրագրավորում։',

    parent3Title: 'Գործնական ուսուցում',
    parent3Desc: 'Փորձ, սխալ և արդյունք։',

    parent4Title: 'Վստահություն',
    parent4Desc: 'Երեխան սկսում է վստահ լինել տեխնոլոգիայի մեջ։',

    parent5Title: 'Ստեղծում',
    parent5Desc: 'Խաղերի փոխարեն՝ ստեղծում։',

    parent6Title: 'Իրական կրթություն',
    parent6Desc: 'Ոչ թե տեսություն, այլ իրական արդյունք։',

    ctaTitle: 'Պատրա՞ստ եք սկսել',
    ctaSubtitle: 'Սկսեք անվճար դասերից։',
    ctaExplore: 'Բոլորը →',
    ctaLessons: 'Դասեր',
  },
  ...
  concepts: {
    electricity: {
      title: 'Ի՞նչ է էլեկտրականությունը',
      description:
        'Էլեկտրականությունը էլեկտրոնների շարժումն է լարի միջով։ Դա է, ինչով աշխատում են լույսերը, սարքերը և բոլոր տեխնոլոգիաները։',
      analogy:
        'Պատկերացրու երեխաներ, որոնք վազում են միջանցքով։ Երբ բոլորը շարժվում են՝ առաջանում է շարժում։',
    },

    voltage: {
      title: 'Ի՞նչ է լարումը',
      description:
        'Լարումը այն ուժն է, որը ստիպում է էլեկտրոններին շարժվել։ Առանց լարման ոչինչ չի աշխատում։',
      analogy: 'Ինչպես հրաման՝ «վազեք»։ Առանց դրա ոչ ոք չի շարժվում։',
    },

    current: {
      title: 'Ի՞նչ է հոսանքը',
      description:
        'Հոսանքը ցույց է տալիս, թե քանի էլեկտրոն է անցնում լարի միջով։',
      analogy: 'Քանի երեխա է վազում միջանցքով։',
    },

    resistance: {
      title: 'Ի՞նչ է դիմադրությունը',
      description:
        'Դիմադրությունը խանգարում է էլեկտրոնների շարժմանը։',
      analogy: 'Նեղ միջանցք, որտեղ դժվար է շարժվել։',
    },

    resistor: {
      title: 'Ի՞նչ է ռեզիստորը',
      description:
        'Ռեզիստորը սահմանափակում է հոսանքը և պաշտպանում սարքերը։',
      analogy: 'Դանդաղեցնող խոչընդոտ ճանապարհին։',
    },

    diode: {
      title: 'Ի՞նչ է դիոդը',
      description:
        'Թույլ է տալիս հոսանքին անցնել միայն մեկ ուղղությամբ։',
      analogy: 'Միակողմանի դուռ։',
    },

    led: {
      title: 'Ի՞նչ է LED-ը',
      description:
        'Դիոդ է, որը լույս է տալիս, երբ հոսանք է անցնում։',
      analogy: 'Լուսավորվող դուռ։',
    },

    capacitor: {
      title: 'Ի՞նչ է կոնդենսատորը',
      description:
        'Կուտակում է էներգիա և հետո արագ տալիս։',
      analogy: 'Լցվում է, հետո միանգամից դատարկվում։',
    },

    transistor: {
      title: 'Ի՞նչ է տրանզիստորը',
      description:
        'Փոքր ազդանշանով կառավարում է մեծ հոսք։',
      analogy: 'Փոքր կոճակ → մեծ դուռ։',
    },

    microcontroller: {
      title: 'Ի՞նչ է միկրոկոնտրոլերը',
      description:
        'Փոքր համակարգիչ, որը կառավարում է սարքերը։',
      analogy: 'Ուսուցիչ, որը հրամաններ է տալիս։',
    },
  },

  lessons: {
    blink: {
      title: 'Առաջին թարթում',
      badge: 'Սկսնակ',
      description:
        'Սովորիր միացնել LED և գրել առաջին կոդը։',
      steps: [
        'Միացրու Arduino',
        'Դիր LED',
        'Միացրու լարերը',
        'Գրի կոդ',
        'Տես՝ ինչպես է թարթում',
      ],
    },

    button: {
      title: 'Կոճակի կառավարում',
      badge: 'Սկսնակ',
      description:
        'Կառավարիր LED կոճակով։',
      steps: [
        'Ավելացրու կոճակ',
        'Միացրու լարերը',
        'Գրի if/else',
        'Սեղմիր և տես արդյունքը',
      ],
    },
  },
},

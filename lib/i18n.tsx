  ...
  comingSoonReply: 'Մեր AI օգնականը դեռ ուսուցման փուլում է։ Շուտով այն կկարողանա պատասխանել քո բոլոր հարցերին։ Մինչ այդ կարող ես դիտել «Հասկացություններ» և «Դասեր» բաժինները 😊',
    ...
    concepts: {
      electricity: {
        ...
        description: 'Անտեսանելի ուժ, որը սնուցում է ամեն ինչ քո շուրջ։ Մենք կբացահայտենք, թե ինչ են էլեկտրոնները, ինչու են շարժվում և ինչ է նշանակում այդ շարժումը։',
        analogy: 'Ինչպես ջուրը հոսում է խողովակով, այնպես էլ էլեկտրոնների հոսքը լարով հենց էլեկտրականությունն է։',
      },
      voltage: {
        title: 'Ի՞նչ է լարումը',
        description: 'Ճնշումը, որը մղում է էլեկտրականությունը լարով։ Չափվում է վոլտերով՝ 1.5 Վ մարտկոցից մինչև 220 Վ պատի վարդակ։',
        analogy: 'Ջրի ճնշումը խողովակում․ որքան բարձր է ճնշումը, այնքան ուժեղ է հոսքը։',
      },
      current: {
        title: 'Ի՞նչ է հոսանքը',
        description: 'Թե որքան էլեկտրականություն է անցնում լարով յուրաքանչյուր վայրկյան։ Չափվում է ամպերով։ Սա քանակն է, ոչ թե ուժը։',
        analogy: 'Թե որքան ջուր է հոսում խողովակով, ոչ թե որքան մեծ է ճնշումը։',
      },
      resistance: {
        title: 'Ի՞նչ է դիմադրությունը',
        description: 'Այն է, ինչը դանդաղեցնում է էլեկտրականության հոսքը։ Չափվում է օհմերով։ V = I × R — Օհմի օրենքը կապում է այս երեք մեծությունները։',
        analogy: 'Խողովակի նեղ հատված, որը դանդաղեցնում է ջրի հոսքը։',
      },
      resistor: {
        title: 'Ի՞նչ է ռեզիստորը',
        description: 'Բաղադրամաս, որի հիմնական գործը որոշակի չափի դիմադրություն ավելացնելն է։ Գունավոր գծերը կոդ են, որոնք ցույց են տալիս՝ քանի օհմ է այն։',
        analogy: 'Արագությունը դանդաղեցնող արգելք էլեկտրականության համար։ Այն պաշտպանում է LED-երը այրվելուց։',
      },
      diode: {
        title: 'Ի՞նչ է դիոդը',
        description: 'Բաղադրամաս, որը թույլ է տալիս էլեկտրականությանը հոսել միայն մեկ ուղղությամբ։ Ճիշտ միացրած դեպքում հոսանքը անցնում է, հակառակ դեպքում՝ ոչ։',
        analogy: 'Միակողմանի դուռ․ կարող ես անցնել առաջ, բայց ոչ հետ։',
      },
      led: {
        title: 'Ի՞նչ է LED-ը',
        description: 'Լույս արձակող դիոդ։ Սա հատուկ դիոդ է, որը լույս է տալիս, երբ իր միջով հոսանք է անցնում։ Robotik հավաքածուում ունես չորս գույն, և դրանք առաջիններից են, որ դու կկենդանացնես։',
        analogy: 'Փայլող դիոդ։ Միացրու ճիշտ ձևով, և այն կլուսավորվի։',
      },
      capacitor: {
        title: 'Ի՞նչ է կոնդենսատորը',
        description: 'Պահում է էլեկտրական էներգիա և հետո արագ թողարկում այն։ Ի տարբերություն մարտկոցի՝ լիցքավորվում և լիցքաթափվում է շատ արագ։',
        analogy: 'Փոքրիկ վերալիցքավորվող տարա՝ լցրու, հետո արագ դատարկիր։',
      },
      transistor: {
        title: 'Ի՞նչ է տրանզիստորը',
        description: '20-րդ դարի ամենակարևոր գյուտերից մեկը։ Այն միաժամանակ անջատիչ է և ուժեղացուցիչ՝ մի փոքր բաղադրիչի մեջ։ Քո հեռախոսում դրանցից միլիարդավորներ կան։ Փոքր ազդանշանը կառավարում է ավելի մեծ ազդանշանը։',
        analogy: 'Ծորակ, որը կառավարվում է էլեկտրականությամբ, ոչ թե ձեռքով։ Փոքր հոսանքը վերահսկում է մեծ հոսքը։',
      },
      microcontroller: {
        title: 'Ի՞նչ է միկրոկառավարիչը',
        description: 'Փոքրիկ համակարգիչ մի չիպի վրա։ Այն ունի պրոցեսոր, հիշողություն և ամենակարևորը՝ մուտքեր ու ելքեր, որոնք կապվում են իրական աշխարհի հետ։ Մուտքերը կարդալ, ելքերը կառավարել՝ սա է ինժեներական մտածողությունը։',
